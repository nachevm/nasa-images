...
Example output
==============
Your API should have a simple command-line interface that just outputs JSON. You don't need to spend time formatting the output. Example output for the last 10 days of curiosity navigation camera images (with a limit of 3 images per day).
...
* Unit tests are not a must but definitely a plus.
